...
#
#修改默认 IP
sed -i 's/192.168.1.1/192.168.6.1/g' package/base-files/files/bin/config_generate   # 定制默认 IP
sed -i 's/ImmortalWrt/360T7/g' package/base-files/files/bin/config_generate   # 定制默认主机名字
